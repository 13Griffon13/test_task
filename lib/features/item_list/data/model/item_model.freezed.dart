...
abstract class $ItemModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String? description, String? avatarUrl});
}
...
class _$ItemModelImpl extends _ItemModel with DiagnosticableTreeMixin {
  const _$ItemModelImpl({required this.name, this.description, this.avatarUrl})
      : super._();
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ItemModel(name: $name, description: $description, avatarUrl: $avatarUrl)';
  }
...
abstract class _ItemModel extends ItemModel {
  const factory _ItemModel(
      ...
      final String? description,
      final String? avatarUrl}) = _$ItemModelImpl;
